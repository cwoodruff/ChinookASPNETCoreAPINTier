...
namespace Chinook.DataEFCore.Repositories
{
    public class AlbumRepository : IAlbumRepository
    {
        ...
        public async Task<List<Album>> GetAllAsync(CancellationToken ct = default(CancellationToken)) => await _context.Album.ToListAsync(ct);

        public async Task<Album> GetByIdAsync(int id, CancellationToken ct = default(CancellationToken)) => await _context.Album.FindAsync(id);
        ...
        public async Task<List<Album>> GetByArtistIdAsync(int id, CancellationToken ct = default(CancellationToken)) => await _context.Album.Where(a => a.ArtistId == id).ToListAsync(ct);
    }
}